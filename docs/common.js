...
/***/ "./src/app/service/vaga.service.ts":
/*!*****************************************!*\
  !*** ./src/app/service/vaga.service.ts ***!
  \*****************************************/
/*! exports provided: VagaService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VagaService", function() { return VagaService; });
...
var VagaService = /** @class */ (function () {
    function VagaService(http) {
        this.http = http;
    }
    VagaService.prototype.getAllVagas = function () {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["BASE_URL_REPOS"] + "/soujava/vagas-java/issues?state=open&page=1&per_page=100");
    };
    VagaService.prototype.getAllVagasPaginacao = function (page, itensPorPagina) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["BASE_URL_REPOS"] + "/soujava/vagas-java/issues?state=open&page=" + page + "&per_page=" + itensPorPagina);
    };
    VagaService.prototype.getVagaById = function (id) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["BASE_URL_REPOS"] + "/soujava/vagas-java/issues/" + id);
    };
    VagaService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
